    ...
    <div>
      ...
      <div className="flex flex-col ml-[50px] lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-2">T-Shirt with Tape Details</h1>
          ...
          <p className="text-gray-700 mt-4">
            This tape details t-shirt is perfect for any occasion. Crafted from a soft and breathable fabric, it offers superior comfort and style.
          </p>
      ...
      <div className="mt-8 border-t ml-[50px]">
        ...
        <div className="mt-4 mb-[50px]">
          <p>This tape details t-shirt is perfect for any occasion. Crafted from a soft and breathable fabric, it offers superior comfort and style.</p>
        </div>
      </div>
    </div>
  );
