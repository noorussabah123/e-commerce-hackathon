  ...
  return (
    <div className="flex flex-wrap justify-center gap-6 p-4">
      {res.map((card: Product, index: number) => {
        ...
        // Fallback for image URL and alt
        const imageUrl = card.image || ''; // Check if image URL is valid
        const altText = card.name || 'Product Image'; // Fallback alt text
          ...
          <Card className="w-full sm:w-1/2 md:w-1/3 lg:w-1/4 shadow-md border rounded-lg" key={index}>
            <CardHeader className="relative">
              {imageUrl ? (
                ...
                <div className="w-full h-48 bg-gray-300 rounded-t-lg flex justify-center items-center">
