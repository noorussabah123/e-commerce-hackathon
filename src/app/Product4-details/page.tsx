    ...
    <div>
      ...
      <div className="flex flex-col ml-[50px] lg:flex-row gap-8">
        ...
        <div className="flex-1">
          <h1 className="text-3xl font-bold mb-2">Sleeve Striped T-Shirt</h1>
          ...
          <p className="text-gray-700 mt-4">
            This Sleeve Striped T-Shirt is perfect for any occasion. Crafted from a soft and breathable fabric, it offers superior comfort and style.
          </p>
          ...
          <div className="mt-6">
            ...
            <div className="flex gap-2 mt-2">
              <button className="w-8 h-8 rounded-full bg-orange-700"></button>
              <button className="w-8 h-8 rounded-full bg-gray-800"></button>
              <button className="w-8 h-8 rounded-full bg-indigo-600"></button>
            </div>
          </div>
      ...
      <div className="mt-8 border-t ml-[50px]">
        ...
        <div className="mt-4 mb-[50px]">
          <p>This Sleeve Striped T-Shirt is perfect for any occasion. Crafted from a soft and breathable fabric, it offers superior comfort and style.</p>
        </div>
      </div>
    </div>
  );
